...
const TrendingClothes = () => {
    return (
        <div>
            <div className="text-4xl md:text-6xl text-center select-none font-bold py-6 mx-24 mt-2 drop-shadow-lg font-cardo border-b-2 border-[#de993f]">Trending Clothes</div>
