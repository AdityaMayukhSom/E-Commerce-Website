...
const Gallary = () => {
    return (
        <div className="px-4 pt-10 mx-auto flex flex-wrap">
            <div className="w-full mb-10 text-2xl sm:text-3xl md:text-6xl font-bold text-center border-b-2 mx-24 font-cardo drop-shadow-md border-[#de993f] pb-6 ">Styles That You Love.</div>
