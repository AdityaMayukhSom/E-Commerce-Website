...
const Footer = () => {
    return (
        <footer className="bg-transparent pt-2 mt-4 ">
            <div className="flex flex-col lg:flex-row border-t-2 border-[#da9e1c] mx-8 pt-4">
                <div className="w-full flex flex-col items-center md:items-start lg:w-1/3 mb-10 px-2 md:px-8">
                    <Link to="/" className="inline-flex">
                        <img className="h-24" src="./images/logoInvert.png" alt="Logo"></img>
                    </Link>
                    <div className="">
                        <div className="tracking-wide flex justify-center pt-2 mb-6 w-full md:w-fit h-12 border-b-2 border-yellow-400 border-dashed pb-6">
                            <span className="text-xl md:text-3xl lg:text-2xl  font-extrabold  whitespace-normal sm:whitespace-nowrap ">Subscribe For Updates</span>
                        </div>
            ...
            <div className="flex flex-col justify-between text-center md:text-left pt-4 pb-6 border-t border-[#da9e1c] md:flex-row mx-10">
                <div className="flex flex-col md:flex-row items-center">
                    <p className="text-sm ">© Copyright 2022. Built With ❤️ By Aditya Mayukh Som.</p>
