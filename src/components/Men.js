    ...
    return (
        <div>
            <div className=" h-36 justify-center items-center flex bg-cover overflow-hidden relative">
                ...
                <div className="flex select-none text-4xl md:text-6xl uppercase whitespace-nowrap font-poppins font-semibold tracking-wider drop-shadow-lg absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 z-10">
                    Men's Section
                </div>
            </div>
