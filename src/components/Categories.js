...
const Categories = () => {
    return (
        <div className="px-4 py-6 mx-auto flex flex-wrap">
            <div className="w-full mb-10 text-2xl sm:text-3xl md:text-6xl font-bold whitespace-nowrap text-center border-b-2 mx-12 md:mx-24 font-cardo drop-shadow-md border-gray-300 pb-6 text-gray-900">Categories To Bag</div>
