			...
			<div className="max-w-[400px] sm:max-w-[300px] md:max-w-[280px] w-full h-full lg:max-w-[350px] bg-[#191919] text-[#b88746] shadow rounded-lg overflow-hidden">
				...
				<div className="p-4 flex flex-col mb-2">
					...
					<div className="flex flex-row">
						<button
							className="py-3 mx-2 px-4 w-1/2 disabled:opacity-50 mt-2 flex items-center justify-center     bg-yellow-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-yellow-600 hover:shadow-lg  focus:outline-none focus:ring-0 active:bg-yellow-700 active:shadow-lg transition duration-150 ease-in-out"
						>
							Add To Cart
						</button>
						<button
							className="py-3 mx-2 px-4 w-1/2 disabled:opacity-50 mt-2 flex items-center justify-center 
