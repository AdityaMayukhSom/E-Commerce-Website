            ...
            <div className="flex flex-row flex-wrap h-full text-gray-800">
                ...
                <div className="w-full  lg:w-1/2 flex flex-col items-center justify-center">
                    ...
                    <form className="max-w-[600px] min-w-[300px] sm:min-w-[450px]">
                        ...
                        <div className="flex justify-between items-center mb-6">
                            <div className="form-group form-check">
                                <input
                                    ...
                                    id="exampleCheck3"
                                />
                                <label className="inline-block text-white" htmlFor="exampleCheck2">
                                    Remember Me
                                </label>
                            </div>
                            <a href="#!" className="text-blue-500 active:text-blue-700 hover:underline hover:underline-offset-2">
                                Forgot password?
                            </a>
                        </div>
                        ...
                        <a
                            className="px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center mb-3 bg-[#3b5998] hover:bg-[#233e77]"
                            href="#!"
                            role="button"
                            data-mdb-ripple="true"
                            data-mdb-ripple-color="light"
                        ...
                        <a
                            className="px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out w-full flex justify-center items-center bg-[#218bdc] hover:bg-[#0175ce]"
                            href="#!"
                            role="button"
                            data-mdb-ripple="true"
                            data-mdb-ripple-color="light"
